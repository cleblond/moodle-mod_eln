...
class mod_eln_edit_page_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addHelpButton('content', 'formathtml', 'eln');

        // attachments
        if ($this->_customdata->attachments) {
            $mform->addElement('filemanager', 'attachments', get_string('attachments', 'eln'), null, array('subdirs' => 0));
        }
