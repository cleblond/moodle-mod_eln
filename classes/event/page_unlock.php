...
class page_unlock extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' unlocked eln page {$this->other['info']}
    ...
    public static function get_name() {
        return get_string('event:pageunlock', 'mod_eln');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'eln', 'unlock', $this->other['logurl'],
