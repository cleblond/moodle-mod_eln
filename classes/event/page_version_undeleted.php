...
/**
 * The mod_eln delete eln event class.
 *
 * @package    mod_eln
 * @since      Moodle 2.7
 * @copyright  2014 The Open University
...
class page_version_undeleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' undeleted eln page with the course module id '$this->contextinstanceid'
    ...
    public static function get_name() {
        return get_string('event:elndelete', 'mod_eln');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'eln', 'version delete', $this->other['logurl'],
