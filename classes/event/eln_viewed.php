 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class eln_viewed extends \core\event\base {
    ...
    public function get_description() {
        $str1 = "The user with id '$this->userid' viewed eln page {$this->other['info']}
    ...
    public static function get_name() {
        return get_string('event:elnviewed', 'mod_eln');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'eln', $this->other['action'], $this->other['logurl'],
