...
class page_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event:elnpageupdated', 'mod_eln');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the page {$this->other['info']} with id '$this->objectid'
                for the eln with the course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        $logurl = substr($this->other['logurl'], strlen('/mod/eln/'));
        return array($this->courseid, 'eln', 'page updated', $logurl,
