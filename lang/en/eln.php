...
//ousearch integration
$string['ousearch'] = 'ELN search';
...
$string['thisexperiment'] = 'The page';
$string['wikiintro'] = 'Description';
$string['wikisettings'] = 'ELN settings';

$string['formathtml'] = 'HTML format';
$string['formathtml_help'] = 'The HTML editor may be used for formatting content.';


$string['modulename'] = 'ELN';
$string['modulenameplural'] = 'ELN\'s';
$string['pluginadministration'] = 'ELN administration';
$string['pluginname'] = 'ELN';
...
$string['subwikis_single'] = 'Single ELN for course';
$string['subwikis_groups'] = 'One ELN per group';
$string['subwikis_individual'] = 'Separate ELN for every user';
...
$string['pagedoesnotexist']='does not yet exist in the notebook.';
$string['startpagedoesnotexist']='This ELN\'s index has not yet been created.';
$string['createpage']='Create page';

$string['recentchanges']='Latest edits';
$string['seedetails']='full history';
$string['startpage']='My ELN Index';
...
$string['wikifor']='Viewing ELN for: ';
...
the relevant parts into another program. If you put your changes back in the notebook later, be careful
...
$string['countdowntext'] = 'This ELN allows only {$a} minutes for editing. Make your changes and click Save or Cancel before the remaining time (to right) reaches zero.';
...
$string['nowikipages'] = 'This ELN does not have any pages.';

$string['error_export'] = 'An error occurred while exporting ELN data.';
...
$string['eln:addinstance'] = 'Add a new ELN';
$string['eln:edit']='Edit ELN pages';
$string['eln:view']='View ELNs';
$string['eln:overridelock']='Override locked pages';
$string['eln:viewgroupindividuals']='Per-user subwikis: view same group';
$string['eln:viewallindividuals']='Per-user subwikis: view all';
$string['eln:viewcontributions']='View list of contributions organised by user';
$string['eln:deletepage'] = 'Delete ELN pages';
$string['eln:viewparticipation'] = 'View participation of all enrolled users who have access to wiki';
$string['eln:grade'] = 'Grade users who have have access to wiki';
...
$string['advice_wikirecentchanges_changes_nohighlight']='<p>The table below lists all changes to any page on this ELN, beginning with the latest changes.</p>
<p>Using the links you can view a page as it looked after a particular change, or see what changed at that moment.</p>';
$string['advice_wikirecentchanges_pages']='<p>This table shows when each page was added to the ELN, beginning with the most recently-created page.</p>';
...
$string['timelocked_before']='This ELN is currently locked. It can be edited from {$a}.';
$string['timelocked_after']='This ELN is currently locked and can no longer be edited.';

$string['returntopage']='Return to ELN page';

$string['savetemplate']='Save ELN as template';
...
$string['entirewiki']='Entire ELN';
$string['onepageview']='You can view all pages of this ELN at once for convenient printing or permanent reference.';
...
$string['overviewnumentrysince1'] = 'new ELN entry since last login.';
$string['overviewnumentrysince'] = 'new ELN entries since last login.';

$string['pagenametoolong'] = 'The page name is too long. Use a shorter page name.';
$string['pagenameisstartpage'] = 'The page name is the same as the index page. Use a different page name.';

$string['eln:lock'] = 'Allowed to lock and unlock pages';
$string['eln:annotate'] = 'Allowed to annotate';
...
$string['lockediting'] = 'Lock ELN - no editing';
...
$string['thispageislocked'] = 'This ELN page is locked and cannot be edited.';
...
Example: the search term <tt>extraction -recrystallization &quot;benzioc acid&quot;</tt> will return results for &lsquo;extraction&rsquo; or the phrase &lsquo;benzoic acid&rsquo; but will exclude items containing &lsquo;recrystallization&rsquo;.';

$string['sizewarning'] = 'This ELN page is very large and may operate slowly.
...
$string['externaldashboardremove'] = 'Remove ELN from dashboard';

// Wiki Form Help
$string['completion_help'] = '
<ul>
<li>
If you choose "Require new pages" then the ELN will be marked as complete for
...
<li>
If you choose "Require edits" then the ELN will be marked as complete for a
...
With this tab you can add inline annotations to ELN pages (for example, teacher comments on student work).';
$string['editbegin_help'] = '<p>If you enable this option the ELN enters read-only mode until the given date. In read-only mode users can see pages, navigate between them, view history, and participate in discussions, but they cannot edit pages.</p>';
$string['editend_help'] = 'If you enable this option the ELN enters read-only mode from the given date onwards.';
$string['createlinkedwiki'] = 'Creating a new page';
$string['createlinkedwiki_help'] = 'While editing, you can type a link to a experiment that doesn&rsquo;t exist yet, such as [[Distillation]]. Then save this page and click on the &lsquo;Distillation&rsquo; link to create the new experiment.

It is also possible to create new experiments from the &lsquo;View&rsquo; tab using the &lsquo;Create new experiment&rsquo; box.';
$string['allowediting_help'] = '
<p>
If you enable this option the ELN enters read-only mode until the given date. In read-only mode
...
<p>
If you enable this option the ELN enters read-only mode from the given date onwards.
</p>';
$string['modulename_help'] = '
<p>
Electronic laboratory notebook (ELN) system that lets users edit a set of linked notebook pages.
</p>';
$string['subwikis_help'] = '
<ul>
<li><strong>Single ELN for course</strong><br />
This ELN behaves as one single ELN. Everybody on the course sees the same pages.</li>
<li><strong>One ELN per group</strong><br />
Members of each group see an entirely separate copy of the ELN (sub-ELN) specific to their
...
<li><strong>Separate ELN for every user</strong><br />
Every single user gets an entirely different ELN. You can only see your own ELN unless
...
$string['summary_help'] = '
<p>
If you enter a summary it will appear on the index page of the ELN. The summary appears
above the normal, editable ELN text and cannot itself be edited by users.
</p>

<p>
Summaries are entirely optional and your ELN may not need one. If you don\'t need a
summary, just leave the box blank.
</p>';
$string['template_help'] = '
<p>
A template is a predefined set of ELN pages. When a template is set, the ELN starts off
with the content defined in the template.
</p>

<p>
The template applies to each subELN; in "One ELN per group" mode, for example, each
group\'s ELN is initialised with the pages in the template.
</p>

<p>
To create a template, write the pages you want on any ELN, then visit the Index page and
click the "Save ELN as template" button. (You can also manually create templates in other
software; it is an extremely simple XML format. Look at a saved template to see the format.)
</p>

<p>
You can add the template after the ELN has been created. Adding a template only affects
newly created sub-ELN\'s, existing ones will remain as at present. </p>';
$string['timeout_help'] = '
<p>
If you select a timeout, people editing the ELN are only allowed to edit it for a given time.
The ELN locks pages while they are being edited (so that two people can\'t edit the same page
at once), so setting a timeout prevents the ELN becoming locked for others.
</p>
...
$string['errorcoursesubwiki'] = 'Must be &lsquo;No groups&rsquo; unless sub-ELNs option is &lsquo;One ELN per group&rsquo;';
$string['errorgroupssubwiki'] = 'Must be enabled when sub-ELNs option is &lsquo;One ELN per group&rsquo;';
...
$string['import_nocontent'] = 'This ELN activity contains no available content to import.';
$string['import_selectsubwiki'] = 'Select ELN';
$string['import_selectsubwiki_help'] = 'Choose from available ELNs. ELNs that do not have any content will not be listed.';
...
$string['allowimport_help'] = 'Checking the box will add the ability to \'import\' pages from other ELNs in the course into the current ELN ';
